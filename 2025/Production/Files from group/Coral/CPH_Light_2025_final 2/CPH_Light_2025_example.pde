...
void draw() {
    ...
    if (millis() > timer + interval) {
        ...
        myMessageMadNoise1GlobalSpeed.add(1-smooth_data_percentage); 
        myMessageMadNoise1Brightness.add(smooth_data_percentage); 
        myMessageMadNoise2GlobalSpeed.add(1-smooth_data_percentage); 
        myMessageMadNoise2Brightness.add(smooth_data_percentage);         
        myMessageMadNoise3GlobalSpeed.add(1-smooth_data_percentage); 
        myMessageMadNoise3Brightness.add(smooth_data_percentage);         
        myMessageMadNoise4GlobalSpeed.add(1-smooth_data_percentage); 
